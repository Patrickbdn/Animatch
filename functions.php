...
add_action( 'init', 'cptui_register_my_cpts' );
function cptui_register_my_cpts_animal() {
...
add_action( 'init', 'cptui_register_my_cpts_animal' );
function cptui_register_my_taxes() {
...
add_action( 'init', 'cptui_register_my_taxes' );
function cptui_register_my_taxes_ville() {
...
add_action( 'init', 'cptui_register_my_taxes_ville' );
function cptui_register_my_taxes_genre_animal() {
...
add_action( 'init', 'cptui_register_my_taxes_genre_animal' );